...
namespace HankoSpa.Services
{
    public class UserService : IUserService
    {
        ...
        private const string CacheKey = "Usuarios";
        ...
        public async Task<IEnumerable<UserDTO>> GetAllUsersAsync()
        {
            ...
            var cached = SimpleCacheManager.Instance.Get<List<UserDTO>>(CacheKey);
            if (cached != null)
            {
                return cached;
            }
            ...
            var dtoList = _mapper.Map<List<UserDTO>>(usersList);
        ...
        public async Task<Response<List<UserDTO>>> GetAllUsersComboAsync()
        {
            ...
            if (cached != null)
            {
                return new Response<List<UserDTO>>(true, "Usuarios obtenidos correctamente. (desde caché)", cached);
            }
            ...
            try
            {
                ...
                return new Response<List<UserDTO>>(true, "Usuarios obtenidos correctamente.", dtoList);
            }
            catch (Exception ex)
            {
                return HandleException<List<UserDTO>>(ex, "Error al obtener los usuarios.");
            }
        }
